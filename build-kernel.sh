...
sudo sh -c 'echo "deb-src http://de.archive.ubuntu.com/ubuntu noble main restricted universe⁄ndeb-src http://de.archive.ubuntu.com/ubuntu noble-updates main restricted universe"'
